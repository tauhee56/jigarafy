export const THEMES = [
  {
    ...
    colors: ["#ffffff", "#0ea5e9", "#d946ef", "#171717"],
  ...
  },
  {
    ...
    colors: ["#171717", "#38bdf8", "#f0abfc", "#fafafa"],
    description: "Sophisticated dark theme with excellent contrast",
    category: "Professional"
  },
  {
    name: "corporate-blue",
    label: "Corporate Blue",
    colors: ["#ffffff", "#1e40af", "#7c3aed", "#111827"],
    description: "Traditional corporate theme with deep blues",
    category: "Corporate"
  },
  {
    name: "modern-gradient",
    label: "Modern Gradient",
    colors: ["#ffffff", "#6366f1", "#ec4899", "#0f172a"],
    description: "Contemporary theme with vibrant gradients",
    category: "Modern"
  },
  {
    name: "light",
